      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute">
        <div class="container">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo"> أكاديمية فقط لنتعلم</a>
            <button
            ...
            >
              <ul class="navbar-nav">
                ...
                <router-link to="/register" tag="li" class="nav-item">
                  <a class="nav-link" style="width: 10rem">
                    <i class="nc-icon nc-badge" style="width: 3rem"></i>
                    <span> انشاء حساب </span>
                  </a>
                </router-link>
                <router-link to="/login" tag="li" class="nav-item">
                  <a class="nav-link" style="width: 10rem">
                    <i class="nc-icon nc-mobile" style="width: 3rem"></i>
